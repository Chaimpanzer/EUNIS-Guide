const data = {
  "questions": [
    {"id":"1","text":"Régulièrement cultivés","answers":[{"text":"Oui","next":"11"},{"text":"Non","next":"2"}]},
    ...
    {"id":"7","text":"Humidité","answers":[{"text":"Gorgée d'eau","next":"D"},{"text":"Autres","next":"8"}]},
    {"id":"8","text":"Végétation dominante","answers":[{"text":"Herbacées non graminées / mousses / lichens","next":"E"},{"text":"Autres","next":"9"}]},
    {"id":"9","text":"% du couvert végétal","answers":[{"text":"< 30 %","next":"H"},{"text":"> 30 %","next":"10"}]},
    {"id":"10","text":"Végétation dominante","answers":[{"text":"Arbustes ou arbustes nains","next":"F"},{"text":"Autres","next":"H"}]},
    {"id":"11","text":"Habitats construits, très artificiels ou régulièrement cultivés","answers":[{"text":"Oui","next":"12"},{"text":"Non","next":"J"}]},
    {"id":"12","text":"Types de végétation","answers":[{"text":"Herbacées","next":"I"},{"text":"Arbres","next":"G"},{"text":"Arbustes","next":"J"}]}
  ],
  "states": {
    "A": "Habitats marins",
    "B": "Habitats côtiers",
